---
description: Generate Postman collection from Controller classes (New version)
---

# /NewGenerate-postman

## Purpose
Generate Postman v2.1 collection from Controller classes for API testing (enhanced version).
...
## Difference from /generate-postman
This is an enhanced version with improved:
- Request body examples
- Response examples
- Environment variable handling

## Related Commands
- `/generate-postman` - Original version
